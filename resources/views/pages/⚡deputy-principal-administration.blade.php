...
class extends Component
{
    ...
    {
        $this->deputyAdmin = TeamMember::with([
                'assignments.role',
                'assignments.department',
            ])
            ->whereHas('assignments', function ($query) {
                $query->where('custom_title', 'Administration')
                    ->whereHas('role', function ($roleQuery) {
                        $roleQuery->where('slug', 'deputy-principal');
                    });
            })
            ->first();

        $this->nonAcademicDepartmentsList = Department::where('type','<>','academic')->get();
    }
}
?>
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="md:w-1/3 lg:w-1/4">
                    <div
                        ...
                        <img src="{{ asset('storage/'.$deputyAdmin->photo) }}" alt="{{ $deputyAdmin->name }}"
                ...
                <div class="p-8 md:w-2/3 lg:w-3/4">
                    ...
                    <div class="mt-6">
                        <h3 class="pb-2 mb-4 text-xl font-semibold text-primary border-b border-orange-200">A Message
                            from Deputy Principal - Administration</h3>
                        <div class="prose text-gray-700 max-w-none">
                            <p>Welcome to the Administration Office. Our department is dedicated to ensuring efficient
                                institutional operations, student welfare, and administrative excellence. We work
                                tirelessly to create an enabling environment for teaching and learning.</p>
                        </div>
                    </div>
                ...
                <div class="w-full p-8 text-center">
                    <div class="p-12 rounded-lg bg-gray-50">
                        ...
                        <p class="text-gray-500">Deputy Principal Administration's information not available at this
                            time.</p>
                    </div>
                </div>
                @endif
    ...
    <section class="relative py-16 overflow-hidden bg-cyan-950" data-aos="fade-up" data-aos-duration="800">
        ...
        <div class="relative max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-3xl lg:text-4xl font-extrabold text-white mb-4" data-aos="fade-up" data-aos-delay="100">
                Ready to <span class="text-primary">Join Our Institution?</span>
            </h2>
