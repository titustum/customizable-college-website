...
class extends Component
{
    ...
    {
         $this->deputyAcademics = TeamMember::with([
                'assignments.role',
                'assignments.department',
            ])
            ->whereHas('assignments', function ($query) {
                $query->where('custom_title', 'Academics')
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="md:w-1/3 lg:w-1/4">
                    <div
                        ...
                        <img src="{{ asset('storage/'.$deputyAcademics->photo) }}" alt="{{ $deputyAcademics->name }}"
                ...
                <div class="p-8 md:w-2/3 lg:w-3/4">
                    ...
                    <div class="mt-6">
                        <h3 class="pb-2 mb-4 text-xl font-semibold text-primary border-b border-orange-200">A Message
                            from Deputy Principal - Academics</h3>
                        <div class="prose text-gray-700 max-w-none">
                            <p>Welcome to the Academics Office. Our department is committed to maintaining high academic
                                standards, curriculum delivery, and quality assurance. We ensure our students receive
                                the best technical and vocational education aligned with industry needs.</p>
                        </div>
                    </div>
        ...
        <div class="relative max-w-4xl mx-auto px-6 text-center">
            ...
            <div class="flex flex-wrap items-center justify-center gap-4" data-aos="zoom-in" data-aos-delay="300">
                <a href="{{ route('courses') }}"
                    ...
                    View Courses <x-ionicon-arrow-forward class="text-xs"/>
                </a>
