...
<main class="bg-gray-50">
    ...
    <section class="relative clip-diagonal grain py-20 overflow-hidden bg-gray-900">
        ...
        <div class="container relative z-10 px-4 mx-auto text-center">
            <span class="inline-block px-4 py-1.5 rounded-full bg-primary/20 text-primary text-xs font-bold tracking-widest uppercase mb-4" data-aos="fade-down">News & Updates</span>
            <h1 class="hero-display mb-4 text-4xl font-bold text-white md:text-5xl lg:text-6xl" data-aos="fade-up">Latest News</h1>
            <p class="max-w-2xl mx-auto text-lg text-gray-300 md:text-xl" data-aos="fade-up" data-aos-delay="100">Stay updated with the latest news, events, and announcements from {{ $institution->name }}.</p>
        </div>
    </section>
                ...
                <div class="relative overflow-hidden rounded-2xl shadow-xl">
                    <div class="grid lg:grid-cols-2">
                        ...
                        <div class="p-8 flex flex-col justify-center bg-white">
                            <span class="inline-block self-start px-3 py-1 mb-4 text-xs font-bold text-white bg-primary rounded-full">
                                Featured
                            </span>
                            ...
                            <h2 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">{{ $featuredUpdate->title }}</h2>
    ...
    <section class="py-16 bg-white border-t border-gray-100">
        <div class="max-w-3xl mx-auto px-4 text-center" data-aos="fade-up">
            ...
            <p class="text-gray-600 mb-8">Subscribe to our newsletter to receive the latest updates and news directly in your inbox.</p>
            <form class="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
                ...
                <button type="submit" class="px-8 py-3 bg-primary text-white font-bold rounded-xl hover:bg-orange-700 transition-colors">
                    Subscribe
                </button>
            </form>
        </div>
